--
-- Created by ada_generator.py on 2012-05-09 10:14:49.102778
-- 
with Based108_Data;
...
package body Ville_IO is
   ...
   --
   --
   -- Does this Ville equal the default Based108_Data.Null_Ville ?
   --
   function Is_Null( Ville : Based108_Data.tVille ) return Boolean is
   use Based108_Data;
   begin
      return Ville = Based108_Data.Null_Ville;
   end Is_Null;
   ...
   --
   function Is_Empty( Ville_Liste : Based108_Data.Ville_List.Vector ) return Boolean is
   use Based108_Data;
   begin
   ...
   --
   function Card( Ville_Liste : Based108_Data.Ville_List.Vector ) return Count_Type is
   use Based108_Data;
   begin
   ...
   --
   function Retrieve_By_PK( Nom_Ville : Unbounded_String ) return Based108_Data.tVille is
      l : Based108_Data.Ville_List.Vector;
      Ville : Based108_Data.tVille;
      c : d.Criteria;
   begin      
      Add_Nom_Ville( c, Nom_Ville );
      l := retrieve( c );
      if( not Based108_Data.Ville_List.is_empty( l ) ) then
         Ville := Based108_Data.Ville_List.First_Element( l );
      else
         Ville := Based108_Data.Null_Ville;
      end if;
      return Ville;
   end Retrieve_By_PK;
   ...
   --
   function Retrieve( c : d.Criteria ) return Based108_Data.Ville_List.Vector is
   begin      
   ...
   --
   function Retrieve( sqlstr : String ) return Based108_Data.Ville_List.Vector is
   ...
   begin
      ...
      begin -- exception block
         ...
         loop
            ...
            Based108_Data.Ville_List.append( l, Ville );        
         end loop;
   ...
   --
   procedure Update( Ville : Based108_Data.tVille ) is
   ...
   --
   procedure Save( Ville : Based108_Data.tVille; overwrite : Boolean := True ) is   
      ps : sql.SQLHDBC := sql.SQL_NULL_HANDLE;
      connection : dodbc.Database_Connection;
      query : Unbounded_String := INSERT_PART & To_Unbounded_String(" ");
      c : d.Criteria;
      Ville_Tmp : Based108_Data.tVille;
   begin
      if( overwrite ) then
   ...
   procedure Delete( Ville : in out Based108_Data.tVille ) is
         c : d.Criteria;
   begin  
      Add_Nom_Ville( c, Ville.Nom_Ville );
      delete( c );
   ...
   --
   function Retrieve_Child_Festival( Ville : Based108_Data.tVille ) return Based108_Data.tFestival is
   begin
      return Festival_IO.retrieve_By_PK( Ville.Festival_Child.Ville_Festival );
   end Retrieve_Child_Festival;
