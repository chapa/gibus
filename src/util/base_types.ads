--
-- Created by ada_generator.py on 2012-05-09 10:13:50.772874
-- 
with Ada.Text_IO; 
...
package base_types is
   ...
   type tgenre_Enum is ( hard, pop, fusion, punk, alternatif, rockabilly ) ;
   
   MISSING_I_KEY : constant Integer := -12345678;
